  ...
  buildAddProductButtonWidget(BuildContext context) {
    return MaterialButton(
      ...
      onPressed: () async {
        ...
        if(product!=null){
          // update
          _service.updateProduct(title, description, categoryId, discount, price, product!.id);
          Navigator.pop(context);
        }else{
          // add
          Product product = Product(title: title, description: description, mrp: price, discount: discount, categoryId: categoryId, imagePath: '');
          addProduct(product);
        }
